...
class DS1307 : public I2CRTCBase
{
public:
    ...
    DS1307() : I2CRTCBase(0x68) { }

    // TimeOfDay::RTC implementation
    virtual const char *DisplayName() const { return "DS1307"; }

    // I2CDevice overrides
    virtual const char *I2CDeviceName() const override { return "DS1307"; }
