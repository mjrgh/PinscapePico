...
* A companion project, "PWMWorker", turns additional Picos into 24-port
...
Details: [Data Sheet](http://mjrnet.org/pinscape/PWMWorker/DataSheet/PWMWorkerDataSheet.htm); [Project subtree](PWMWorker).
