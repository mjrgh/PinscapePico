...
public:
	...
	Sci::Position Move(int indicator, Sci::Position position) noexcept override;
	Sci::Position Accelerate(int indicator, Sci::Position position) noexcept override;
...
template <typename POS>
Sci::Position DecorationList<POS>::Move(int indicator, Sci::Position position) noexcept {
	const Decoration<POS> *deco = DecorationFromIndicator(indicator);
	if (deco) {
...
template <typename POS>
Sci::Position DecorationList<POS>::Accelerate(int indicator, Sci::Position position) noexcept {
	const Decoration<POS> *deco = DecorationFromIndicator(indicator);
	if (deco) {
