...
public:
	...
	virtual Sci::Position Move(int indicator, Sci::Position position) noexcept = 0;
	virtual Sci::Position Accelerate(int indicator, Sci::Position position) noexcept = 0;
