...
const KeyToCommand KeyMap::MapDefault[] = {
    ...
    {Keys::Accelerate,	 	    SCI_NORM,	Message::LineEnd},
    {Keys::Accelerate,	 	    SCI_SHIFT, 	Message::LineEndExtend},
    {Keys::Accelerate, 		SCI_CTRL, 	Message::DocumentEnd},
    {Keys::Accelerate, 		SCI_CSHIFT, Message::DocumentEndExtend},
    {Keys::Accelerate, 		SCI_ALT, 	Message::LineEndDisplay},
    {Keys::Accelerate,		    SCI_ASHIFT,	Message::LineEndRectExtend},
